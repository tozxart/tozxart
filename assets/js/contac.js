function Pop(){var cssRuleFile="https://popupsmart.com/freechat_style.css";let lnk=document.createElement("link");lnk.setAttribute("rel","stylesheet");lnk.setAttribute("type","text/css");lnk.setAttribute("href",cssRuleFile);document.getElementsByTagName("head")[0].appendChild(lnk);var conDivObj;let content={show:false,logo:"https://d2r80wdbkwti6l.cloudfront.net/Cz74LbbmsqGrFmpcWlqJaQpx6GJwZyEz.jpg",person:"https://d2r80wdbkwti6l.cloudfront.net/ejRUGogUHC4UBHTOImcA90xWBT3ouySZ.jpg",title:"Hi there ✌️",message:"How may we help you? Just send us a message now to get assistance.",color:"#FA764F",position:"right",button:"Write us",placeholder:"Enter your message",withText:"Write with",viaWhatsapp:"Or write us directly via Whatsapp",gty:"Go to your",awu:"and write us",connect:"Connect now",track:0,device:"everywhere",services:[{}],};const freechatSVG=`
