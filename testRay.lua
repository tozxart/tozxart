...
CopyKeyButton.Parent = KeyUI
CopyKeyButton.Size = UDim2.new(0, 100, 0, 25)
CopyKeyButton.Position = UDim2.new(0, 350, 0, 150)
...
CopyKeyButton.MouseButton1Click:Connect(function()
    -- Get the key link from the input box.
    local keyLink = KeyMain.Input.InputBox.Text

    -- Copy the key link to the clipboard.
    clipboard:SetAsync(keyLink)
end)
